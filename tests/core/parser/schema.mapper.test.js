...
describe("SchemaMapper", () => {
    ...
    const schemaTypeMapper = new SchemaTypeMapper(resolver);
    const mapper = new SchemaMapper(schemaTypeMapper);
    it("should map primitive properties", () => {
        const model = mapper.map("UserDto", {
            type: "object",
            required: ["id", "name"],
            properties: {
                id: {
...
//# sourceMappingURL=schema.mapper.test.js.map